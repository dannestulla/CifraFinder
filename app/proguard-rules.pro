...
# R8 removes that info unless we tell it to keep it.
...
-keep class br.gohan.cifrafinder.data.model.** { *; }
-keepclassmembers class br.gohan.cifrafinder.data.model.** { *; }
...
# kept., Retrofit uses these for API method return types
